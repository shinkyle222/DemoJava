...
public class TokenEx01 {
	...
	public static void main(String[] args) {
		...
		//다음 토큰의 확인 /nextToken식은 반환한다. (공백도 자른다.)
//		System.out.println(token1.nextToken()); //오늘은
//		System.out.println(token1.nextToken()); //날씨가
//		System.out.println(token1.nextToken()); //맑고
//		System.out.println(token1.nextToken()); //매우
//		System.out.println(token1.nextToken()); //시원하지
//		System.out.println(token1.nextToken()); //않습니다.
		
		//다음 토큰의 여부확인 /hasMoreToken은 boolean타입으로 반환
